# Повний довідник серверної конфігурації

Згенеровано з TOML, який NeoForge створив і завантажив під час перевірки клієнта. Усі параметри мають тип SERVER та штатно синхронізуються NeoForge. Значення default — вбудовані значення нового балансу.

Файл цієї версії NeoForge: `config/cbcatfix-server.toml`. Попередній `config/cbcatfix-common.toml` більше не керує грою; він не видаляється. Для перенесення власних значень зупиніть гру/сервер і перенесіть потрібні ключі в новий файл. Нові межі перевіряє NeoForge. У головному меню, до завантаження SERVER-конфігурації, tooltip використовує вбудовані defaults.

| Категорія | Параметр | Default | Межі | Сторона | Дія |
|---|---|---|---|---|---|
| rockets.small | maxSpeedBlocksPerTick | 7.0 | 0.1 ~ 20.0 | SERVER | Maximum powered speed in blocks per tick. |
| rockets.small | guidedTurnRateDegreesPerTick | 11.0 | 0.0 ~ 45.0 | SERVER | Maximum guided turn rate in degrees per tick. |
| rockets.small | poweredFlightSeconds | 3.0 | 0.05 ~ 120.0 | SERVER | Powered flight time in seconds for a long-range rocket. A double-payload rocket receives half of this duration. |
...
| rockets.medium | maxSpeedBlocksPerTick | 5.5 | 0.1 ~ 20.0 | SERVER | Maximum powered speed in blocks per tick. |
| rockets.medium | guidedTurnRateDegreesPerTick | 8.0 | 0.0 ~ 45.0 | SERVER | Maximum guided turn rate in degrees per tick. |
...
| rockets.medium | maximumGuidanceRangeBlocks | 512.0 | 1.0 ~ 4096.0 | SERVER | Maximum distance in blocks at which a guided rocket can retain its target. |
...
| rockets.big | maxSpeedBlocksPerTick | 4.0 | 0.1 ~ 20.0 | SERVER | Maximum powered speed in blocks per tick. |
| rockets.big | guidedTurnRateDegreesPerTick | 5.0 | 0.0 ~ 45.0 | SERVER | Maximum guided turn rate in degrees per tick. |
| rockets.big | poweredFlightSeconds | 12.0 | 0.05 ~ 120.0 | SERVER | Powered flight time in seconds for a long-range rocket. A double-payload rocket receives half of this duration. |
| rockets.big | durability | 40.0 | 1.0 ~ 1000.0 | SERVER | Damage required to shoot this rocket down. |
| rockets.big | maximumGuidanceRangeBlocks | 1024.0 | 1.0 ~ 4096.0 | SERVER | Maximum distance in blocks at which a guided rocket can retain its target. |
...
| rockets.guidance | lightweightMassMultiplier | 0.85 | 0.1 ~ 1.0 | SERVER | Mass multiplier for the one-warhead, one-fuel lightweight recipe. |
| rockets.guidance | lightweightFuelMultiplier | 0.65 | 0.05 ~ 1.0 | SERVER | Powered-flight-time multiplier for the one-warhead, one-fuel lightweight recipe. |
...
| rockets.payload | doublePayloadMultiplier | 1.5 | 1.0 ~ 2.0 | SERVER | Double-warhead damage/effect and penetrator mass scale; fuel remains halved. |
...
| munitions.cbcAt.autocannon.apds | quadraticDrag | false | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.cbcAt.autocannon.apdsfs | quadraticDrag | false | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.cbcAt.autocannon.he | quadraticDrag | false | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.cbcAt.autocannon.hei | quadraticDrag | false | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.cbcAt.heavyAutocannon.ap | quadraticDrag | true | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.cbcAt.heavyAutocannon.apds | quadraticDrag | true | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.cbcAt.heavyAutocannon.apdsfs | quadraticDrag | true | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.cbcAt.heavyAutocannon.he | quadraticDrag | true | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.cbcAt.heavyAutocannon.hef | quadraticDrag | true | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.cbcAt.heavyAutocannon.heat | quadraticDrag | true | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.cbcAt.heavyAutocannon.smoke | quadraticDrag | true | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.cbcAt.bigCannon.cluster | quadraticDrag | false | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.cbcAt.bigCannon.cluster | canSquib | true | true / false | SERVER | Allow native insufficient-charge squib behavior. |
...
| munitions.fix.bigCannon.flak | quadraticDrag | false | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.fix.bigCannon.flak | canSquib | true | true / false | SERVER | Allow native insufficient-charge squib behavior. |
...
| munitions.fix.bigCannon.heavyHe | quadraticDrag | false | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.fix.bigCannon.heavyHe | canSquib | true | true / false | SERVER | Allow native insufficient-charge squib behavior. |
...
| munitions.fix.bigCannon.heat | quadraticDrag | false | true / false | SERVER | Use quadratic instead of linear native drag. |
...
| munitions.fix.bigCannon.heat | canSquib | true | true / false | SERVER | Allow native insufficient-charge squib behavior. |
| munitions.fix.bigCannon.heat | addedRecoil | 1.2 | 0.0 ~ 100.0 | SERVER | Additional native big-cannon recoil. |
| munitions.fix.bigCannon.hesh | entityDamage | 20.0 | 0.0 ~ 1000.0 | SERVER | Direct hit damage in health points, before armor and other native damage rules. |
| munitions.fix.bigCannon.hesh | knockback | 1.0 | 0.0 ~ 1000.0 | SERVER | Native projectile knockback strength. |
| munitions.fix.bigCannon.hesh | gravity | -0.05 | -1.0 ~ 0.0 | SERVER | Vertical ballistic acceleration in blocks/tick squared; zero disables gravity. |
| munitions.fix.bigCannon.hesh | drag | 0.01 | 0.0 ~ 1.0 | SERVER | Native linear or quadratic drag coefficient. |
| munitions.fix.bigCannon.hesh | quadraticDrag | false | true / false | SERVER | Use quadratic instead of linear native drag. |
| munitions.fix.bigCannon.hesh | durabilityMass | 2.5 | 0.0 ~ 100.0 | SERVER | CBC penetrator mass consumed by impacts; distinct from rocket hull health. |
| munitions.fix.bigCannon.hesh | penetration | 3.0 | 0.0 ~ 100.0 | SERVER | CBC armor penetration coefficient; not a fixed number of blocks. |
| munitions.fix.bigCannon.hesh | toughness | 3.0 | 0.0 ~ 100.0 | SERVER | CBC resistance to projectile shatter. |
| munitions.fix.bigCannon.hesh | deflection | 0.3 | 0.0 ~ 1.0 | SERVER | CBC angle coefficient used by the native ricochet calculation. |
| munitions.fix.bigCannon.hesh | addedChargePower | 0.0 | 0.0 ~ 100.0 | SERVER | Additional native big-cannon charge power. |
| munitions.fix.bigCannon.hesh | minimumChargePower | 1.0 | 0.0 ~ 1000.0 | SERVER | Minimum charge power used by native squib checks. |
| munitions.fix.bigCannon.hesh | canSquib | true | true / false | SERVER | Allow native insufficient-charge squib behavior. |
| munitions.fix.bigCannon.hesh | addedRecoil | 1.5 | 0.0 ~ 100.0 | SERVER | Additional native big-cannon recoil. |
| munitions.fix.bigCannon.hesh | spallDistanceBlocks | 4.0 | 0.0 ~ 64.0 | SERVER | Maximum spall travel distance behind the impact in blocks. |
| munitions.fix.bigCannon.hesh | spallRadiusBlocks | 2.0 | 0.0 ~ 64.0 | SERVER | Radius of the spall damage area in blocks. |
| munitions.fix.bigCannon.hesh | maximumBlocksDestroyed | 2 | 0 ~ 64 | SERVER | Maximum terrain blocks affected by the spall effect. |
| munitions.fix.bigCannon.hesh | spallEntityDamage | 35.0 | 0.0 ~ 1000.0 | SERVER | Spall damage in health points. |
